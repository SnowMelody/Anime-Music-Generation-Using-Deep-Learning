...
model.summary()
tf.keras.utils.plot_model(model, 'model1_shape.png', show_shapes = True)
...
rnd_num = 8765 # choose a random starting sequence as the seed
pred_input_melody = np.array([train_input_melody[rnd_num]])
pred_input_rmid = np.array([train_input_rmid[rnd_num]])
pred_input_lmid = np.array([train_input_lmid[rnd_num]])
pred_input_bass = np.array([train_input_bass[rnd_num]])
...
generated_rmid = []
generated_lmid = []
generated_counter = np.tile(train_input_counter[rnd_num], 3)
generated_motifs = np.tile(train_input_motifs[rnd_num], 3)
generated_form = np.tile(train_input_form[rnd_num], 3)

#t_m = np.array()
#t_f = np.array()
#generated_motifs = np.append(generated_motifs, t_m)
#generated_form = np.append(generated_form, t_f)

print(generated_counter)
print(generated_motifs)
print(generated_form)
print(melody_motifs_to_int)
print(form_to_int)
